"""MACE-Field extension built on the current MACE model architecture.

The field coupling is intentionally kept as an extension of ``ScaleShiftMACE``:
all foundation-model parameters are constructed by the upstream MACE model and
the field blocks are added only at the interaction interfaces.
"""
...
from mace.modules.wrapper_ops import FullyConnectedTensorProduct, Linear
